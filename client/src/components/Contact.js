	...
	return (
		<>
			<div className="contact-hero">
				<HeroImage
					category="commercial"
					imgLink="commercial2.jpg"
					className="contact-page-hero"
				/>
				<div className="layer">
					<section className="contact-text-container">
						<h1 className="contact-layer-header">Contact us</h1>
						<div className="layer-border-bottom"></div>
						<p>
							Hi There, <br />I am looking forward to hearing from you. Please
							feel free to get in touch via the form below, I will get back to
				...
				<section className="contact-form-container">
					<form onSubmit={handleSubmit}>
						...
						<div className="btn-container">
							<button
								type="submit"
								className="button-primary form-button-primary"
							>
								Submit
							</button>
						</div>
